...
function TestimonialsCarousel() {
  ...
  const testimonials = [
    {
      id: 1,
      name: "Evelyn Lopes",
      text: "Tá tudo perfeito! Tô amando me desafiar. Ir para a academia era 'chato' e agora tem sido algo incrível, eu vou com prazer, tudo por conta de ter um treino adequado.",
      avatar: "/placeholder.svg?height=40&width=40",
    },
    {
      id: 2,
      name: "Mônica Moura",
      text: "Só elogios, essa consultoria foi um presente que me dei, e hoje estou vendo que foi uma ótima escolha. Bele uma ótima profissional, tenho me surpreendido com os treinos e dedicação.",
      avatar: "/placeholder.svg?height=40&width=40",
    },
    {
      id: 3,
      name: "Natália Alves",
      text: "Gostei muito dos treinos! Os exercícios encaixaram super bem e deu até mais ânimo para treinar. Também amei o cardio. Essa divisão por minuto faz com que o tempo passe mais rápido e é muito bom ter as velocidades certinhas indicadas. Graças a isso, me desafiei e estou correndo em uma velocidade que nunca tinha corrido antes. O suporte pelo whats também foi excelente. Tive todas as dúvidas supridas e correção dos exercícios.",
      avatar: "/placeholder.svg?height=40&width=40",
    },
    {
      id: 4,
      name: "Vitória Malves",
      text: "Seu treino é incrível!!! Eu sei que teria resultados muito melhores se eu fosse treinasse com mais dedicação e eu quero mt fazer isso ahahaha mas ainda assim os resultados tem sido mto bons ❤️",
      avatar: "/placeholder.svg?height=40&width=40",
    },
    {
      id: 5,
      name: "Geovana Santana",
      text: "Bele mais uma vez muitíssimo obrigada pela dedicação no acompanhamento, sei que por vezes eu deveria ter me empenhado mais seja na execução dos exercícios ou na progressão de carga mas pela primeira vez senti que levei os treinos na academia mais a sério e com um real propósito. Sempre tive o grande desejo de hipertrofiar mais sentia que nunca dava tudo de mim e ficava frustrada por não atingir os objetivos que almejava mas hoje percebo que se ainda não cheguei no corpo que quero chegar é porque não me desafiei o suficiente e ter isso em mente e o seu apoio e acompanhamento estão me dando mais garra para me desafiar, terminar todas as séries não ter medo de progredir carga ou de ir até a falha, coisa que eu não fazia antes por estar muito acomodada num treino 'fofo'. Por isso, eu peço que continue me desafiando, continue me cobrando e exigindo o máximo de mim pois eu sei que com o seu auxílio serei capaz que alcanças meus objetivos!",
      avatar: "/placeholder.svg?height=40&width=40",
    },
  ]
  ...
  const getVisibleTestimonials = (index: number) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      result.push(testimonials[testimonialIndex])
    }
    return result
  }
  ...
  useEffect(() => {
    setVisibleTestimonials(getVisibleTestimonials(0))
  }, [])
  ...
  return (
    <div className="relative max-w-6xl mx-auto">
        ...
        >
          {visibleTestimonials.map((testimonial, index) => (
            <Card
              ...
              className="border-0 shadow-lg h-full transform transition-all duration-500 ease-in-out"
              style={{
                animationDelay: `${index * 100}ms`,
                animation: isTransitioning ? "fadeOut 300ms ease-in-out forwards" : "fadeIn 500ms ease-in-out forwards",
              }}
            >
      ...
      <button
        ...
        className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-10 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <button
        onClick={nextSlide}
        disabled={isTransitioning}
        className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-10 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="mt-4 w-full bg-gray-200 rounded-full h-1 overflow-hidden">
        <div
          className="bg-green-600 h-1 rounded-full transition-all duration-500 ease-in-out"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div className="relative">
              ...
              <p className="text-xs text-gray-500 text-center mt-4 italic">
                Personal trainer registrado no Conselho Federal de Educação Física sob o número 177611-G/SP
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="text-center relative">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  <br />
                  você já terá acesso a todo material disponível no app.
                </p>
              </div>
      ...
      <section className="py-20" style={{ backgroundColor: "#b7d9c0" }}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-sm text-gray-700">Resposta em até 24 horas • Avaliação inicial gratuita</p>
          </div>
        </div>
      </section>
